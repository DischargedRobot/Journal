...
const STEP_HEADER_CONTAINER_CLASS =
	"cursor-pointer grid grid-cols-[auto_1fr] grid-rows-[3rem_2rem] gap-x-2 items-center"
const NUMBER_CLASS =
...
const ERROR_MESSAGE_CLASS = "col-span-full row-start-2"
...
const StepHeader = (props: Props) => {
	...
	return (
		<>
			{disabled ? (
				<Box
					className={classNamesTwMerge(
						STEP_HEADER_CONTAINER_CLASS,
