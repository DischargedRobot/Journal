...
const CheckboxRectCheckedIcon = ({ sx, ...props }: SvgIconProps) => (
	<SvgIcon
		{...props}
		viewBox="0 0 16 16"
	...
	>
		...
		<path className="checkbox-box" d={boxPath} />
		<path className="checkbox-check" d="M4.50012 8L7.00004 10.4999" />
		<path className="checkbox-check" d="M7 10.5L13 3.5" />
	</SvgIcon>
)

export default CheckboxRectCheckedIcon
